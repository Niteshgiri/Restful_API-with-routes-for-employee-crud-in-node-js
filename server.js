...
app.get("/",(req,res) =>{
  ...
  //  res.json({message :"wlcome to employee management project "})
    ...
    let sql ="CREATE TABLE IF NOT EXISTS employee(id int AUTO_INCREMENT, name VARCHAR(255),email VARCHAR(255), role VARCHAR(255),address VARCHAR(255), PRIMARY KEY(id))";
